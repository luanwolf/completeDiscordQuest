...
assert.match(src, /root -g/);
assert.match(src, /Node \$MinNodeMajor\+ e obrigatorio/);
assert.match(src, /pnpm global nao esta disponivel/);
...
const installFlow = src.slice(src.indexOf("function Invoke-Install"));
assert.ok(installFlow.indexOf('Install-Toolchain') < installFlow.indexOf('$localApp'));
