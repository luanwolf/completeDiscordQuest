<#
    ...
    Se nao achar, clona o Vencord. Exige Node 22+ e pnpm global.
...
function Install-Toolchain {
    if (-not (Has-Cmd git)) {
        throw 'Git e obrigatorio para instalar o Vencord. Instale em https://git-scm.com/download/win e rode de novo.'
    }
    Write-Ok 'Git pronto'
...
function Invoke-Install {
    ...
    Write-Host '    1. Usar Git, Node 22+ e pnpm global ja validados' -ForegroundColor DarkGray
